...
--
-- Name: games games_winner_idid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT games_winner_idid_fkey FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
